...
% ============================================================================
\begin{abstract}
In 2018, Ukraine's Ministry of Foreign Affairs launched \#KyivNotKiev---a campaign to change how English-language media spells Ukrainian place names. We present the largest computational study of toponym adoption to date, scanning over 90 billion records across 7 datasets and extracting 40 million toponym matches---including 39.6M news article references, 573M Wikipedia pageviews, and 379K academic papers---tracking 55 Ukrainian--Russian spelling pairs from 2010 to 2026. Our big data analysis reveals that adoption is highly domain-dependent (cross-source spread: 54 percentage points median), with an OLS regression model explaining 87\% of adoption variance ($R^2 = 0.87$).
...
\begin{enumerate}
\item \textbf{Large-scale empirical measurement.} We scan 90 billion+ records across 7 datasets, extracting 40 million toponym matches for 55 Ukrainian--Russian spelling pairs across 8 semantic categories from 2010 to 2026---the largest study of toponym adoption to date.
